...
public class ExamHistoryExceptionHandler {
    private static final DateTimeFormatter FORMATTER = DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm:ss");

    @ExceptionHandler(ExamHistoryException.class)
    public ResponseEntity<Map<String, String>> handleAppException(ExamHistoryException exception) {
        HttpStatus status = exception.getExamHistoryError().getHttpStatus();
